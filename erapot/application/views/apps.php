...
<head lang="en">
    ...
    <link href="<?= base_url('assets/metro-ui/css/metro.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/metro-ui/css/metro-icons.css') ?>" rel="stylesheet">
    <!--<link href="../css/metro-responsive.css" rel="stylesheet">-->

    <script src="<?php echo base_url("js/jquery-1.10.2.min.js"); ?>"></script>
    <script src="<?= base_url('assets/metro-ui/js/metro.min.js') ?>"></script>
        ...
        $(function(){
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position){
                    ...
                    $.ajax({
                        url: 'https://api.forecast.io/forecast/219588ba41dedc2f1019684e8ac393ad/'+pos+'?units=si',
                        dataType: 'jsonp',
...
<body style="overflow-y: hidden;">
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        ...
        <div class="tile-area-controls">
            <button class="image-button icon-right bg-violet fg-white bg-hover-dark no-border"><span class="sub-header no-margin text-light">
				<?= get_data('users','user_id',$this->session->userdata('user_id'),'nama') ?></span> <span class="icon mif-user"></span>
			</button>
            <button class="square-button bg-green fg-white bg-hover-dark no-border" onclick="showCharms('#charmSearch')"><span class="mif-search"></span></button>
            <button class="square-button bg-green fg-white bg-hover-dark no-border" onclick="showCharms('#charmSettings')"><span class="mif-cog"></span></button>
            <a href="<?= base_url("auth/logout") ?>" class="square-button bg-green fg-white bg-hover-dark no-border"><span class="mif-switch"></span></a>
        </div>
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                ...
                <div class="tile-large bg-steel fg-white" data-role="tile" data-on-click="document.location.href='https://forecast.io'">
        ...
        <div class="tile-group double">
            <span class="tile-group-title">Main Modules</span>
            <div class="tile-container">
                <div class="tile bg-darkBlue fg-white" data-role="tile" onclick="document.location.href='<?= base_url('beli_minta') ?>'">
                    <div class="tile-content iconic">
                        <span class="icon mif-envelop"></span>
                    </div>
