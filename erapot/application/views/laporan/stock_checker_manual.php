    							...
    							<div class="form-group">
    								...
    								<div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-2">
            									<div class="input-group">
                                                <button class="btn btn-info" id="btn-submit" type="submit" onclick="validateForm()">Check Stock</button>
                                                </div>
                                            </div>
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                <button class="btn btn-primary" id="btn-submit-updater" type="submit" onclick="updaterForm()">Hitung Ulang</button>
                                                </div>
                                            </div>
                                        </div>
    								</div>
