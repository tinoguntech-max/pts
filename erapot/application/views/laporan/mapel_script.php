<div class="modal fade" id="toroModal" tabindex="-1" role="dialog" aria-labelledby="toroModalLabel">
	...
	<script>
		...
		function generate_laporan() {
				var brands = $('#mapel option:selected');
				var selected = [];
				...
				$.get("<?php echo base_url("laporan"); ?>/laporan_mapel_ajax/"+encodeURIComponent(selected)+"/"+encodeURIComponent(selected1), function(data) {
					$("#toro-area").html(data);
