                    ...
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-wrench"></i></div>
							...
							<!--<div class="form-group">
								<label for="jual_order" class="col-sm-4 control-label">Nomor Order</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="so_no" name="so_no" placeholder="Nomor Order" />
									</div>
								</div>
							</div>-->
							<div class="form-group">
