				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="tgl1" class="col-sm-4 control-label">Tanggal Awal</label>
								<div class="col-sm-8">
									<div class="input-group">
							...
							<div class="form-group">
								<label for="m_cabang" class="col-sm-4 control-label">Barang</label>
								<div class="col-sm-8">
									<div class="input-group">
							...
							<div class="form-group">
								<label for="rb_no" class="col-sm-4 control-label">Nomor Retur Beli</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="rb_no" name="rb_no" placeholder="Nomor Retur Beli" />
									</div>
								</div>
							</div>
							<div class="form-group">
