				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="rj_no" class="col-sm-4 control-label">Nomor Jual Order</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="so_no" name="so_no" placeholder="Nomor Jual Order" />
									</div>
								</div>
							</div>
							<div class="form-group">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="ui two statistics">
									...
									<div class="statistic">
										<div class="value">
											<i class="dollar icon"></i> <span id="n_total">0</span>
										</div>
										<div class="label">
											Total
										</div>
