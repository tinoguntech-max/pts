				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="tgl1" class="col-sm-4 control-label"><?= $this->lang->line('beli_bayar_tanggal'); ?></label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></div>
										<input type="text" class="form-control" id="tgl1" name="tgl1" placeholder="<?= $this->lang->line('beli_bayar_tanggal'); ?>">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="no_faktur" class="col-sm-4 control-label"><?= $this->lang->line('beli_bayar_no_faktur'); ?></label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="no_faktur" name="no_faktur" placeholder="<?= $this->lang->line('beli_bayar_no_faktur'); ?>" >
									</div>
								</div>
							</div>
							<div class="form-group">
