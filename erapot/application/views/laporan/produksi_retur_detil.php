				...
				<div class="container-fluid panel">
					...
					<div class="row">
						<div class="col-lg-12 form-horizontal">
							...
							<div class="form-group">
								<label for="rj_no" class="col-sm-4 control-label">Nomor Retur Produksi</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="rp_no" name="rp_no" placeholder="Nomor Retur Produksi" />
									</div>
								</div>
							</div>
							<div class="form-group">
