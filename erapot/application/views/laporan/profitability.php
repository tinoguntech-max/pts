                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="ui two statistics">
									...
									<div class="statistic">
										<div class="value">
											<i class="lemon icon"></i> <span id="t_quantity">0</span>
										</div>
										<div class="label">
											Item Total
										</div>
                                ...
                                <div class="ui three statistics">
									<div class="statistic">
										<div class="value">
											<i class="dollar icon"></i> <span id="t_hpp">0</span>
										</div>
										<div class="label">
											HPP Total
										</div>
									...
									<div class="statistic">
										<div class="value">
											<i class="dollar icon"></i> <span id="t_harga_jual">0</span>
										</div>
										<div class="label">
											Harga Jual Total
										</div>
									...
									<div class="statistic">
										<div class="value">
											<i class="dollar icon"></i> <span id="t_profit">0</span>
										</div>
										<div class="label">
											Profit Total
										</div>
