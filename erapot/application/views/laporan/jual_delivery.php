				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="do_no" class="col-sm-4 control-label">Nomor Delivery</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="do_no" name="do_no" placeholder="Nomor Delivery" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="kendaraan_nama" class="col-sm-4 control-label">Nama Kendaraan</label>
								<div class="col-sm-8">
									<div class="input-group">
							...
							<div class="form-group">
								<label for="kendaraan_nopol" class="col-sm-4 control-label">Nopol Kendaraan</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-drivers-license"></i></div>
										<input class="form-control" type="text" id="kendaraan_nopol" name="kendaraan_nopol" placeholder="Nopol Kendaraan" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="kendaraan_sopir" class="col-sm-4 control-label">Sopir Kendaraan</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-user-circle-o"></i></div>
										<input class="form-control" type="text" id="kendaraan_sopir" name="kendaraan_sopir" placeholder="Sopir Kendaraan" />
									</div>
								</div>
							</div>
							<div class="form-group">
