				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="cabang" class="col-sm-4 control-label"><?= $this->lang->line('cabang'); ?></label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-bank"></i></div>
										<select class="form-control" required id="cabang" name="cabang" placeholder="Cabang" multiple="multiple">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="input-group">
										...
										<select class="form-control" id="barang" name="barang" placeholder="<?= $this->lang->line('barang'); ?>" multiple="multiple">
											<?php if(isset($barang)) : ?>
