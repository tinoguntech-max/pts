				...
				<div class="row">
                    <div class="col-md-12">
                        <section class="panel">
							...
							<div class="form-group">
								<label for="rj_no" class="col-sm-4 control-label">Nomor Retur Jual</label>
								<div class="col-sm-8">
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
										<input class="form-control" type="text" id="rj_no" name="rj_no" placeholder="Nomor Retur Jual" />
									</div>
								</div>
							</div>
							<div class="form-group">
