                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-12 form-horizontal">
									...
									<div class="form-group">
										<label for="tgl3" class="col-sm-4 control-label">Tanggal Jatuh Tempo</label>
										<div class="col-sm-8">
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-fw fa-calendar"></i></div>
												<input type="text" class="form-control" id="tgl3" name="tgl3" placeholder="Tanggal Jatuh Tempo">
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="inv_no" class="col-sm-4 control-label">Invoice Number</label>
										<div class="col-sm-8">
											<div class="input-group">
									...
									<div class="form-group">
										<label for="po_no" class="col-sm-4 control-label">Sales Order Number</label>
										<div class="col-sm-8">
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
												<input class="form-control" type="text" id="so_no" name="so_no" placeholder="Sales Order Number" />
											</div>
										</div>
									</div>
									<div class="form-group">
										<label for="bpb_no" class="col-sm-4 control-label">Delivery Order Number</label>
										<div class="col-sm-8">
											<div class="input-group">
												<div class="input-group-addon"><i class="fa fa-fw fa-certificate"></i></div>
												<input class="form-control" type="text" id="do_no" name="do_no" placeholder="Delivery Order Number" />
											</div>
										</div>
									</div>
									<div class="form-group">
