    ...
    <section>
					...
					<li class="menu-list<?php if($viewoptions['section'] == "laporan_gudang") echo " active"; ?>">
                        ...
                        <ul id="collapsePembelian" class="child-list">
							...
							<li<?php if($viewoptions['section'] == "laporan_gudang" && $viewoptions['page'] == "stock") echo " class=\"active\""; ?>>
								<a href="<?php echo base_url("laporan_stock/laporan_stocks"); ?>"><i class="fa fa-fw fa-shopping-basket"></i> <?= $this->lang->line('stock'); ?></a></li>
							<?php endif; ?>
							<?php if (strpos($this->session->userdata('user_access'),'stock_laporan_manage') !== false) : ?>
					...
					<li class="menu-list<?php if($viewoptions['section'] == "laporan_finance") echo " active"; ?>">
                        ...
                        <ul id="collapseFinance" class="child-list">
							...
							<li<?php if($viewoptions['section'] == "laporan_finance" && $viewoptions['page'] == "journal") echo " class=\"active\""; ?>>
								<a href="<?php echo base_url("laporan_finance/laporan_journal"); ?>"><i class="fa fa-fw fa-check"></i> <?= $this->lang->line('journal'); ?></a></li>
							<?php endif; ?>
						</ul>
                    </li>
					<?php endif; ?>
        ...
        <div class="body-content" >
            ...
            <div class="header-section">
                ...
                <!--mega menu start-->
                <div id="navbar-language" class="navbar-collapse collapse yamm mega-menu">
                    <ul class="nav navbar-nav">
                        <!-- Classic dropdown -->
                        <?php if ($this->session->userdata('user_language') == 'english') : ?>
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                                class=" fa fa-angle-down"></b></a>
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="<?= base_url('profile/language/indonesia') ?>">
										<span> Indonesia </span><img src="<?= base_url('img/flags/indonesia_flag.jpg') ?>" width="18" height="12" alt=""/>
									</a>
                                </li>
                            </ul>
                        </li>
						<?php else : ?>
						<li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> Indonesia  <b
                                class=" fa fa-angle-down"></b></a>
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="<?= base_url('profile/language/english') ?>">
										<span> English </span><img src="<?= base_url('img/flags/usa_flag.jpg') ?>" width="18" height="12" alt=""/>
									</a>
                                </li>
                            </ul>
                        </li>
				...
				<div id="navbar-dashboard" class="navbar-collapse collapse yamm mega-menu">
                    <ul class="nav navbar-nav">
                        <!-- Classic dropdown -->
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> Boards
							<b class=" fa fa-angle-down"></b></a>
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="<?= base_url('dashboard') ?>">
										<span><i class="fa fa-fw fa-dashboard"></i> General Dashboard </span>
									</a>
                                </li>
								<?php if (strpos($this->session->userdata('user_access'),'crm_lead_manage') !== false) : ?>
								<li>
                                    <a tabindex="-1" href="<?= base_url('crm_lead/kanban') ?>">
										<span><i class="fa fa-fw fa-eye"></i> Lead Kanban </span>
									</a>
                                </li>
								<?php endif; ?>
								<?php if (strpos($this->session->userdata('user_access'),'crm_opportunity_manage') !== false) : ?>
								<li>
                                    <a tabindex="-1" href="<?= base_url('crm_opportunity/kanban') ?>">
										<span><i class="fa fa-fw fa-info"></i> Opportunity Kanban </span>
									</a>
                                </li>
								<?php endif; ?>
                            </ul>
                ...
                <li class="d-none">
                    ...
                    <div class="dropdown-menu dropdown-title">
                        <div class="title-row">
                            ...
                            <a href="<?= base_url('email') ?>" class="btn-primary btn-view-all">View all</a>
                        </div>
                        <div class="notification-list mail-list">
                            ...
                            <a href="javascript:;" class="single-mail">
                                ...
                                <p>
                                    <small>Toro Developer is awesome</small>
                                </p>
                            ...
                            <a href="javascript:;" class="single-mail">
                                ...
                                <small> Just Now</small>
                                <p>
                                    <small>No hassle, very easy to use... It's Toro!!!</small>
                                </p>
                                <span class="read tooltips" data-original-title="Mark as Unread" data-toggle="tooltip" data-placement="left">
                                    <i class="fa fa-circle-o"></i>
                                </span>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
								...
								<?php if (strpos($this->session->userdata('user_access'),'general_manage') !== false) : ?>
								<li><a href="<?php echo base_url("general"); ?>">  Setting</a></li>
								<?php endif; ?>
                                <li>
