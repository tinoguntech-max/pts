			...
			<div id="page-wrapper" class="wrapper">
				<div class="container-fluid">
					...
					<form name="hotlineForm" action="<?php echo base_url("pos_beli_terima_satuan"); ?>/<?php echo $viewoptions['action']; if($viewoptions['action'] == 'update') echo '/'.base64_encode($primary); ?>" onsubmit="return validateForm();" method="post">
						<section class="panel">
						...
						<div class="row">
							<div class="col-lg-4 form">
								...
								<div class="form-group">
									<label for="m_cabang">PPN Status</label>
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-percent"></i></div>
										<select class="form-control" 
												required data-bind="value: PPNstatus, valueAllowUnset: true, options: $root.availablePPNStatus, 
												optionsText: 'nama', optionsValue: 'id', select2: { placeholder: '--- Choose PPN Status ---', 
													allowClear: true, theme: 'bootstrap' }">
											</select>
									</div>
								</div>
								<div class="form-group">
									<label for="customer_nama">General PPN</label>
									<div class="input-group">
										<span ><strong><?= get_data('general','id',13,'nilai') ?> %</strong></span>
									</div>
								</div>
							</div>
							<div class="col-lg-4 form">
								<div class="form-group toro-ui">
									<label for="type">Request Type</label>
									<div class="chooseInput">
										<input type="radio" id="cgeneral" checked="checked" value="0" data-bind="buttonset: requestType"/>
										<label for="cgeneral">General</label>
										<input type="radio" id="cmaster" value="1" data-bind="buttonset: requestType"/>
										<label for="cmaster">Master Data</label>
									</div>
								</div>
								<div class="form-group" data-bind="visible: $root.requestType() == 0">
									<label for="customer_nama">Nama Supplier</label>
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-child"></i></div>
										<input class="form-control"  placeholder="Nama Supplier" value="" data-bind="value: supplier_nama" />
									</div>
									<label for="customer_telp">No Telp Supplier</label>
									<div class="input-group">
										<div class="input-group-addon"><i class="fa fa-child"></i></div>
										<input class="form-control"  placeholder="No Telp Supplier" value="" data-bind="value: supplier_telp" />
									</div>
								</div>
								<div class="form-group" data-bind="visible: $root.requestType() == 1">
												...
												<table class="table table-striped table-hover" id="toro">
													...
													<tbody data-bind="sortable: organizers">
														<tr>
															...
															<td><input type="number"  min="0" class="form-control" data-bind="value: pos_harga" /></td>
															<td><input type="number" step="0.01" min="0.01" class="form-control" data-bind="value: pos_jumlah" /></td>															
															<td>
																<select class="form-control" required data-bind="foreach: satuanList, value: selectedSatuanConvert, optionsCaption: 'Choose Satuan Convert'">
																	<option data-bind="attr: { value: id_satuan2 }, text: nama_satuan2"></option>
																</select>
															</td>
