...
//binding select2
	...
	function OrganizerViewModel() {
		...
		self.user_name = ko.observable('<?php if(isset($detil)) echo $detil[0]['user_name'] ?>').extend({required:true, minLength:3, maxLength:50});
		self.user_pass = ko.observable('');
		self.userLevel = ko.observable('<?php if(isset($detil)) echo $detil[0]['user_level'] ?>').extend({required:true});
		self.nama = ko.observable('<?php if(isset($detil)) echo $detil[0]['nama'] ?>').extend({required:true, minLength:3, maxLength:50});
		self.cabang = ko.observable('<?php if(isset($detil)) echo $detil[0]['id_m_cabang'] ?>').extend({required:true});
		self.department = ko.observable('<?php if(isset($detil)) echo $detil[0]['id_m_department'] ?>').extend({required:true});
		...
		self.screenLanguage = ko.observable('<?php if(isset($detil)) echo $detil[0]['screen_language'] ?>').extend({required:true});
