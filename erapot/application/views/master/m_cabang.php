					...
					<form name="hotlineForm" class="form-horizontal" action="<?php echo base_url("m_cabang"); ?>/<?php echo $viewoptions['action']; if($viewoptions['action'] == 'update') echo '/'.base64_encode($primary); ?>" onsubmit="return validateForm();" method="post">
						...
						<div class="form-group">
							<label for="nama" class="col-sm-2 control-label">Nama / Kode <sup class="text-info">*)</sup></label>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" required maxlength="200"
									value="<?php if(isset($detil)) echo $detil[0]['nama']; ?>">
							</div>
							<div class="col-sm-3">
								<input type="text" class="form-control" id="kode" name="kode" placeholder="Kode" required maxlength="10"
									value="<?php if(isset($detil)) echo $detil[0]['kode']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="users" class="col-sm-2 control-label">Nama Pemimpin</label>
							<div class="col-sm-10">
								<select class="form-control" id="users" name="users" placeholder="Nama Pemimpin">
								<option value="">-- NAMA PEMIMPIN --</option>
									<?php if(isset($users)) : ?>
									<?php if (is_array($users)): ?>
									<?php foreach ($users as $key => $value) : ?>
									<?php if(isset($detil)) : if($detil[0]['id_users'] == $value['user_id']) : ?>
									<option value="<?= $value['user_id'] ?>" selected><?= $value['nama'] ?></option>
									<?php else : ?>
						...
						<div class="form-group">
							<label for="provinces" class="col-sm-2 control-label">Propinsi <sup class="text-info">*)</sup> / Kota</label>
							<div class="col-sm-5">
								<select class="form-control" id="provinces" name="provinces" placeholder="Propinsi" required>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="No Telepon" 
									value="<?php if(isset($detil)) echo $detil[0]['no_telp']; ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="website" class="form-control" id="website" name="website" placeholder="Website"
									value="<?php if(isset($detil)) echo $detil[0]['website']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="gurl" class="col-sm-2 control-label">Google+ URL</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="gurl" name="gurl" placeholder="Google Place URL"
									value="<?php if(isset($detil)) echo $detil[0]['gurl']; ?>">
							</div>
						</div>
						<div class="form-group">
