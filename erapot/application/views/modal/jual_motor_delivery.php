<div class="modal fade" id="toroModalDelete" tabindex="-1" role="dialog" aria-labelledby="toroModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form id="toroForm" method="post" action="<?= base_url('jual_motor_delivery/deleted') ?>">
...
$(document).ready(function(){
	$("#toroModalDelete").on('show.bs.modal', function (event) {
		var button = $(event.relatedTarget);
		var recipient = button.data('pp');
		var modal = $(this);
		$("#toroForm").attr("action", "<?= base_url('jual_motor_delivery/deleted') ?>/" + recipient);
	});
});
</script>