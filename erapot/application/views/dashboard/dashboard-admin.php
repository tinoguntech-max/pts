<!-- page head start-->
            <div class="page-head">
                ...
                <span class="sub-title">Welcome to Toro Developer dashboard</span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <section class="panel purple">
                            ...
                            <div class="value white">
                                <h1 class="timer" data-from="0" data-to="<?php echo $jml_order  ; ?>"
                                    data-speed="1000">
                                    <!--320-->
                                </h1>
                                <p>New Order</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <section class="panel ">
                            ...
                            <div class="value gray">
                                <h1 class="purple-color timer" data-from="0" data-to="<?php echo $jml_item  ; ?>"
                                    data-speed="1000">
                                    <!--123-->
                                </h1>
                                <p>Item Sold</p>
                        ...
                        <section class="panel">
                            ...
                            <div class="slick-carousal">
                                ...
                                <div id="news-feed" class="owl-carousel owl-theme">
									<?php if (isset($news)): ?>
									<?php if (is_array($news)): $a=0; ?>
									<?php foreach ($news as $key => $value) : $a++; ?>
                                    <div class="item">
                                        <h3 class="text-success"><?= get_m_content_jenis_news($value['id_m_content_jenis_news']) ?></h3>
                                        <span class="date"><?php $date=date_create($value['tanggal']); echo date_format($date, 'd F Y'); ?></span>
                        ...
                        <section class="panel">
                            <div class="panel-body- weather-widget">
                                ...
                                <div class="weather-info">
                                    ...
                                    <span class="weather-city">Surabaya</span>
                                ...
                                <ul class="team-list cycle-pager external" id='no-template-pager'>
                                    <li>
                                        <a href="javascript:;">
                                            ...
                                            <span class="name">Andy Bintoro</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;">
