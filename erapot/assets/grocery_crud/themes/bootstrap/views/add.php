                            ...
                            <?php foreach($fields as $field) { ?>
                                <div class="form-group <?php echo $field->field_name; ?>_form_group">
                                    <label class="col-sm-3 control-label">
										...
										<?php if (isset($this->toro_tooltip[$field->field_name])) echo '<span><i class="fa fa-fw fa-info" data-toggle="tooltip" title="'.$this->toro_tooltip[$field->field_name].'"></i></span>'; ?>
									</label>
                                    <div class="col-sm-9">
