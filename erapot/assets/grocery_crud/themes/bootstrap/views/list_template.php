<?php
	...
	$this->set_css($this->default_theme_path.'/bootstrap/css/plugins/dropzone.css');
	...
	$this->set_js_lib($this->default_theme_path.'/bootstrap/js/common/dropzone.js');
    ...
    <div class="container-fluid gc-container">
        ...
        ?></div>
 		...
 		<div class="row">
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-primary" href="<?php if (isset($this->toro_add)) echo $this->toro_add; else echo $add_url; ?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
							<?php if(isset($this->toro_upload)) : ?>
								<div class="floatL t5">
                                    <a class="btn btn-default" data-toggle="modal" data-target="#toroUpload" 
									href="#"><i class="fa fa-upload"></i> &nbsp; <?php echo $this->l('list_upload'); ?> <?php echo $subject?></a>
                                </div>
							<?php endif; ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
			...
			<!-- Upload dialog -->
			<?php if(isset($this->toro_upload)) : ?>
			<div class="modal fade" id="toroUpload" tabindex="-1" role="dialog" aria-labelledby="toroModalLabel">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h3 class="modal-title" id="toroUploadLabel">Upload Data from Excel</h3>
						</div>
						<div class="modal-body" id="toroUploadBody">
							<form id="toroUploader" method="post" class="dropzone">
								<div class="fallback">
						...
						<div class="modal-footer">
							<?php if(isset($this->toro_upload_link)) : ?>
							<a href="<?= $this->toro_upload_link ?>" class="btn btn-success pull-left"><i class="fa fa-file-excel-o"></i> Download Example</a>
							<?php endif; ?>
			...
			$(document).ready(function(){
				...
				var myDropzone = new Dropzone("#toroUploader", { 
					url: "<?= $this->toro_upload ?>",
					maxFilesize: 15,
					uploadMultiple: false,
					acceptedFiles: ".xls,.xlsx"
				});
				myDropzone.on("success", function(file, response) {
					$('#toroUploadBody').html(response);
				});
			});
			</script>
			<?php endif; ?>
