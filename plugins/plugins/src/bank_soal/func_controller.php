...
function edit($id = "", $uri_back = "")
{
    ...
    if (is_pengajar() AND get_sess_data('user', 'id') != $p['pengajar_id']) {
        $CI->session->set_flashdata('bank', get_alert('warning', 'Soal hanya dapat diperbaharui oleh admin atau pembuat.'));
        redirect($uri_back);
    }
...
function delete($id = "", $uri_back = "")
{
    ...
    # jika sebagai pengajar, cek pembuatnya
    if (is_pengajar() AND get_sess_data('user', 'id') != $p['pengajar_id']) {
        $CI->session->set_flashdata('bank', get_alert('warning', 'Soal hanya dapat dihapus oleh admin atau pembuat.'));
        redirect($uri_back);
    }
