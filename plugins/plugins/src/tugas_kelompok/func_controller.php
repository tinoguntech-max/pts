...
function add()
{
    ...
    $CI->form_validation->set_rules('mapel_id', 'Matapelajaran', 'trim|required');
    ...
    if ($CI->form_validation->run() == TRUE) {
        ...
        $CI->session->set_flashdata('tugas', get_alert('success', 'Tugas kelompok berhasil dibuat, silakan atur kelompok.'));
